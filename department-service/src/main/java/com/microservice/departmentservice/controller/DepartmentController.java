...
@Tag(
    name = "Departement Service - Departement Controller", 
    description = "Departement Service - Departement Controller"
)
@RestController
...
public class DepartmentController {
    ...
    @Operation(
        ...
        description = "Get Department REST API is used to get a department object from a database"
    )
    @ApiResponse(
        responseCode = "200",
